...
const steps: Step[] = [
  {
    icon: <FileText size={64} strokeWidth={1.5} />, // Replace with actual icon component
    label: "Upload your PDF",
    description: "Simply drag and drop your PDF document or click to upload",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />, // Replace with actual icon component
    label: "AI Analysis",
    description:
      "Our advanced AI processes and analyzes your document instantly",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />, // Replace with actual icon component
    label: "Get Summary",
  ...
  return (
    <section className="relative overflow-hidden bg-gray-50">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        {/* Further content for this section would go here */}
        <div className="relative grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto  gap-8 ">
          {steps.map((step, idx) => (
